public class BST_List_inorder_traversal {
  ...
  public BST_List_inorder_traversal(int[] nums) {
    this.nums = nums;
  }
  ...
  private BST_Node get_max(BST_Node root) {
    BST_Node node = root;
  ...
  public static void main(String[] args) {
    ...
    BST_List_inorder_traversal bst = new BST_List_inorder_traversal(nums);
    bst.buildTree();

    // in-order traversal = n * (getMin + delete)
    while (true) {
      BST_Node node_min = bst.get_min(bst.root);
      if (node_min == null) {
        break;
      }
    ...
    while (true) {
      BST_Node node_min = bst.get_max(bst.root);
      if (node_min == null) {
        break;
      }
      System.out.print(node_min.val + " ");
